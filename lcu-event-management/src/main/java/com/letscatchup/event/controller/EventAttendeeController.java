...
public class EventAttendeeController {
	...
	public void removeAttendee(@PathVariable("eventId") Long eventId, @PathVariable("attendeeId") EventAttendeeIdEntity attendeeId) {
		
		eventAttendeeService.removeAttendee(attendeeId);
